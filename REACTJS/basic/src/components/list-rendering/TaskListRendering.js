...
const ProductList = ({ Pic, Price, Discr, Ratings }) => {
  return (
    <div
      style={{
...
const ListRenderingT = () => {
  const [users] = useState([
    ...
    },
    {
      ...
      Discr: "Laptop",
      Ratings: "⭐⭐⭐",
      Pic: "https://apollo-singapore.akamaized.net/v1/files/hng9h6myaim71-IN/image;s=300x600;q=60",
    },
    {
      Price: "₹ 800",
      Discr: "Watch",
  ...
  return (
    <>
      <h3 style={{ color: "blue", marginLeft: 30 }}>
        <b>
          <i>Product List :</i>
        </b>
      </h3>
      <section style={{ display: "flex", justifyContent: "space-evenly" }}>
        {users.map((user) => {
          return <ProductList key={user.Discr} {...user} />;
        })}
      </section>
    </>
  );
